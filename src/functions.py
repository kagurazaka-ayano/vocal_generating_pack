...
def extract_video_audio(video_path:Path, dir_out:Path) -> Path:
    video = VideoFileClip(str(video_path))
    audio = video.audio
    audio.write_audiofile(dir_out / f"{video_path.stem}_audio.wav")
...
audio_from_video = extract_video_audio(Path("./test/2023-06-14_19-06-15.mp4"), Path("./test/"))
resampled = resample(audio_from_video, Path("./test/2023-06-14_19-06-15_resampled_44100.wav"), 44100)
separate_vocal(resampled, Path("./test/"))
